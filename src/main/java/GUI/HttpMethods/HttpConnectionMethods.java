...
public class HttpConnectionMethods {
    ...
    public static List<Book> GetBooks(String urlString,boolean allbooks) {
        Map<String, String> parameters = new HashMap<>();
        parameters.put("allbooks", String.valueOf(allbooks));
    ...
    public static Map<String, Object> Zwroc(String urlString, int bookId) {
        Map<String, String> parameters = new HashMap<>();
        parameters.put("bookId", String.valueOf(bookId));

        Type listOfMyClassObject = new TypeToken<Map<String, Object>>() {}.getType();

        String response = Input(urlString, parameters);
        Gson gson = new Gson();

        //Map<String, Object> test = gson.fromJson(response, listOfMyClassObject);
        return gson.fromJson(response, listOfMyClassObject);
    ...
    public static Map<String, Object> Wypozycz(String urlString, int bookId){
        Map<String, String> parameters = new HashMap<>();
        parameters.put("bookId", String.valueOf(bookId));
